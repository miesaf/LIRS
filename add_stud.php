                ...
                <div class="col-lg-12">
					...
					?>
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-lg-6">
                                    <form role="form" id="add_stud" action ="add_stud.php" method ="POST">
										<input type="hidden" name="REG" value="YES">
                                        <div class="form-group">
											<label>Student ID</label>
                                            <input class="form-control" type="text" size="12" maxlength="10" name="S_ID">
                                        </div>
										<div class="form-group">
											<label>Student Name</label>
                                            <input class="form-control" type="text" size="50" maxlength="100" name="S_NAME">
                                        </div>
										<div class="form-group">
											<label>Student IC</label>
                                            <input class="form-control" type="text" size="12" maxlength="12" name="S_IC">
								...
								<div class="col-lg-6">
										<div class="form-group">
											...
											<input class="form-control" type="text" size="12" maxlength="2" name="S_PART">
										</div>
										<div class="form-group">
											<label>Phone Number</label>
											<input class="form-control" type="text" size="12" maxlength="20" name="S_PHONE">
											<p class="help-block">Eg: +6012-xxx xxxx</p>
										</div>
										<div class="form-group">
											<label>E-Mail</label>
											<input class="form-control" type="text" size="30" maxlength="50" name="S_MAIL">
							...
							<div class="row" align="center">
								<br />
								<button type="submit" class="btn btn-outline btn-success" form="add_stud" value="Submit">Submit</button>
								<button type="reset" class="btn btn-outline btn-warning" form="add_stud" value="Reset">Reset</button>
								<a href="list_stud.php"><button type="button" class="btn btn-outline btn-danger" >Cancel</button></a>
								<br /><br />
							</div>
							<!-- /.row -->
									</form>
