...
<head>
    ...
    <title>[LIRS] - List Approved</title>
...
<body>
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
			<div class="row">
				<div class="col-lg-12">
					<h1 class="page-header">List Approved Reservation</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <center><b>Approved Reservation List</b></center>
                        </div>
                        <!-- /.panel-heading -->
                        ...
                        <?php
							...
							$sql = "SELECT * FROM RESERVE WHERE RV_STAT = \"AP\" ORDER BY RV_IN";
