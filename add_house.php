                ...
                <div class="col-lg-6">
					...
					?>
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-lg-12">
                                    <form role="form" id="add_house" action ="add_house.php" method ="POST">
										<input type="hidden" name="REG" value="YES">
                                        <div class="form-group">
											<label>House ID</label>
                                            <input class="form-control" type="text" size="5" maxlength="3" name="H_ID">
											<p class="help-block">Eg: LI</p>
                                        </div>
										<div class="form-group">
											<label>House Name</label>
                                            <input class="form-control" type="text" size="50" maxlength="100" name="H_NAME">
                                        </div>
										<div class="form-group" align="center">
											<br>
											<button type="submit" class="btn btn-outline btn-success" form="add_house" value="Submit">Submit</button>
											<button type="reset" class="btn btn-outline btn-warning" form="add_house" value="Reset">Reset</button>
